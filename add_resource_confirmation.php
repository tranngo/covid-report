<?php
	...
	if ( !isset($_POST['organization']) || empty($_POST['organization'])
		...
		$statement = $mysqli->prepare("INSERT INTO resources (description, link, organization_id, category_id) VALUES (?, ?, ?, ?)");
		$statement->bind_param('ssii', $description, $_POST['link'], $_POST['organization'], $_POST['category']);
				...
				<div class="col-12">
					...
					<?php if ( isset($error) && !empty($error) ) : ?>
						...
						<div class="form-group row text-center">
							...
							<div class="col-sm-6 mt-2">
								<a href="add_resource.php">Back</a>
							</div>
							<div class="col-sm-3"></div>
						</div>
					<?php endif; ?>
					...
					<?php if ($isUpdated) : ?>
						<div class="alert alert-success" role="alert">
						  	<span class="font-italic"><?php echo $_POST['link']; ?></span> has been added successfully.
						</div>
						<div class="form-group row text-center">
							<div class="col-sm-3"></div>
							<div class="col-sm-6 mt-2">
